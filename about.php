...
<body class="page-about">
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('files/otherheader/2.webp');">
    ...
    <section style="background-color: #001f3f;" id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4" data-aos="fade-up">
          <div class="col-lg-4">
            <img style="height: 500px;" src="files/aboutus/1.webp" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8">
    ...
    <section style="background-color: #47aeff;" id="why-us" class="why-us">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-xl-5 img-bg" style="background-image: url('assets/img/7.jpg')"></div>
