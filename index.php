...
<section  style="background-color: #001f3f;" id="services-list" class="services-list">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="files/index/1.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="files/index/3.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="files/index/4.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
    ...
    <section style="background-color: #47aeff;"  id="why-us" class="why-us">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-xl-5 img-bg" > <img style="width: 100%;height: 531px; " src="files/10.jpg" class="img-fluid rounded-start" alt="..."></div>
...
<br><br><br>
  ...
  <div class="col">
    <div class="card h-100">
      <img src="files/1.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card h-100">
      <img src="files/2.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card h-100">
      <img src="files/3.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card h-100">
      <img src="files/4.jpg" class="card-img-top" alt="...">
      <div class="card-body">
